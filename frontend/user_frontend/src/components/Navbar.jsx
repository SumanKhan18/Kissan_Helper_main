...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        // console.log(token)
        // console.log("Profile data:", res.data); // now this should be the actual user object
        setUser(res.data);
      })
      .catch((err) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6 ml-auto">
            <Link
              to="/"
              className="text-gray-300 hover:text-green-500 text-sm font-medium"
            >
              Home
            </Link>
            <Link
            ...
            <a
              ...
              class="text-gray-300 hover:text-green-500 text-sm font-medium"
            >
              Kisan Store
            </a>
            <Link
            ...
            <div className="flex items-center space-x-4 relative z-[60]">
              ...
              {!user && (
                <Link
                  to="/auth"
                  className="bg-green-500 text-black px-4 py-2 rounded-md text-sm font-medium hover:bg-green-600"
                >
                  Login/Register
                </Link>
              )}
        ...
        {isOpen && (
          ...
          >
            <Link
              ...
              className="block text-gray-300 hover:text-green-500 text-base py-2"
            >
              Home
            </Link>
            <Link
            ...
            {!user && (
              <Link
                to="/auth"
                onClick={() => setIsOpen(false)}
                className="block bg-green-500 text-black px-4 py-2 rounded-md"
              >
                Login/Register
              </Link>
            )}
  ...
  return (
    <div className="relative" ref={notificationRef}>
      <button
        ...
        className="relative p-2 rounded-full bg-gray-800 hover:bg-gray-600 transition"
      >
  ...
  return (
    <div className="relative z-[1000]" ref={menuRef}>
      <button
        ...
        className="p-2 rounded-full bg-gray-800 hover:bg-gray-600 transition"
      >
        ...
        {open && (
          ...
          >
            ...
            <div className="p-2 space-y-1">
              <Link
                to="/user"
                className="flex items-center gap-2 p-2 text-sm text-white hover:bg-gray-800 rounded-md"
              >
              ...
              <button
                onClick={() => {
                  ...
                  window.location.reload(); // forces Navbar to re-render after logout
                }}
